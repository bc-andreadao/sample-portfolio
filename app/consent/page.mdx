...
# SaaS Consent Management -
# Custom Catalyst Implementation

The Consent Manager in the [Catalyst](https://docs.bigcommerce.com/developer/docs/storefront/catalyst/overview) features [c15t](https://c15t.com/) to provide a comprehensive solution for General Data Protection Regulation (GDPR), California Consumer Privacy Act (CCPA), and other privacy regulation compliance.
...
For more info, see the [Static Translations](https://docs.bigcommerce.com/developer/docs/storefront/catalyst/features/localization/static-translations) overview in the Catalyst documentation.
...
Check out the full Catalyst implementation of the consent manager on the `canary` branch! You’ll need to [enable the cookie consent tracking](https://docs.bigcommerce.com/developer/docs/storefront/catalyst/reference/security#enabling-cookie-consent-tracking) in your Control Panel to be able to see the banner on your Catalyst storefront. 

For more information, check out the [Catalyst Consent Management](https://docs.bigcommerce.com/developer/docs/storefront/catalyst/reference/security#consent-management) documentation. 
